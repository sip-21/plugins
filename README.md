...
| ------------------------------------ | ------------------------------------------------------------------------------------------- | :---:        | :---:      |
| [backup][backup]                     | A simple and reliable backup plugin                                                         |  ![Dynamic JSON Badge](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fsip-21%2Fplugins%2Fadd-ci-tests-columns-in-readme%2Fbadges-test-results.json&query=%24.backup.value&color=%24.backup.color&label=) | |
